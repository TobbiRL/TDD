...
tester.isEqual(romanNumeralConverter(692), "DCXCII", "Converting 692 to Roman");
tester.isEqual(romanNumeralConverter(941), "CMXLI", "Converting 941 to Roman");
tester.isEqual(romanNumeralConverter(988), "CMLXXXVIII", "Converting 988 to Roman");
